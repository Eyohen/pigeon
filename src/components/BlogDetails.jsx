...
<p onClick={() => {navigate(-1)}} className='flex items-center gap-x-2 text-gray-500 px-16 mt-9 cursor-pointer'>Home <MdOutlineKeyboardArrowRight /> Blog details</p>
    ...
    <div onClick={() => navigate(-1)} className=''></div>
        ...
        <div className='mt-16'><img src={imageUrl ? imageUrl : frame1} className='object-cover w-[750px] h-[450px]' /></div>
