...
const RestrictModal = ({ isOpen, onClose, communityId, onRestrictionUpdate, children }) => {
  ...
  const editRestriction = async (e) => {
    ...
    try {
      const res = await axios.put(`${URL}/api/communities/restrict/${communityId}`, updatedInfo, {
        headers: {
