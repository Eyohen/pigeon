...
<p className='mt-4'>Email</p>
<input onChange={(e) => setEmail(e.target.value)} className='border border-[#D7D7D7] w-full md:w-[600px] py-2 px-3 rounded-lg hover:border-[#F08E1F] border-r-4'/>



<div className='justify-center items-center mt-9 flex'>
<button onClick={handleSubmit}  className='hover:bg-[#F08E1F] bg-gray-200 px-[265px] hover:text-white rounded-full text-gray-500 py-2'>Continue</button>
</div>
        </div> }
