...
const AdminRestrictedCommunities = () => {
...
console.log("userId",user)
    ...
    const fetchCommunities = async () => {
        try {
            const res = await axios.get(`${URL}/api/visible/restricted`);
...
<div className='flex-1 ml-[330px] '> 
    <Navbar2/>
        <p className='text-3xl ml-[48px]'>Restricted Communities</p>
...
export default AdminRestrictedCommunities