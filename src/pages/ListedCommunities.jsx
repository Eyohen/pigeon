...
const ListedCommunities = () => {
    ...
    const fetchCommunities = async () => {
      setLoading(true)
      try {
        const res = await axios.get(`${URL}/api/comunities/${user?.id}/communities`);
        console.log('my list',res.data)
      ...
      <div>
        ...
        <div className='flex-1 ml-[300px]'>
          ...
          <div className='flex items-center justify-start gap-x-24'>
            <p className='ml-12 font-semibold text-4xl mt-9'>Listed Communities</p>
...
export default ListedCommunities;